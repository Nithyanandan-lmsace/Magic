 ...
 * @package auth_magic
 */
class campaign_availableandtotalcapacitystatus extends abstract_field_attribute {
    ...
    public function transform_data($data, \stdClass $record) {
        ...
        $record = new \stdClass();
        if ($data) {
            $record->available = $data - $campaignusers;
            $record->total = $data;
            return get_string('valutotalandavailablecapacity', 'auth_magic', $record);
        }
