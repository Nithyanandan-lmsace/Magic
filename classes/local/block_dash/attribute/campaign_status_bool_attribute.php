 ...
 * @package block_dash
 */
class campaign_status_bool_attribute extends abstract_field_attribute {
    ...
    public function transform_data($data, \stdClass $record) {
        if (!$data) {
            $data = get_string('campaigns:available', 'auth_magic');
        } else {
            $data = get_string('campaigns:archived', 'auth_magic');
        }
