...
Feature: Magic campaign report source workflow.
  ...
  Scenario: Report source campaign group
    ...
    And I should see "5" in the ".generaltable tr:nth-child(1) td:nth-child(2)" "css_element"
    And I should see "3" in the "demo user04 Demo campaign2" "table_row"
    And I should see "Unlimited" in the ".generaltable tr:nth-child(3) td:nth-child(2)" "css_element"
    And I should see "0" in the ".generaltable tr:nth-child(1) td:nth-child(3)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(2) td:nth-child(3)" "css_element"
    And I should see "5" in the ".generaltable tr:nth-child(1) td:nth-child(4)" "css_element"
    And I should see "2" in the ".generaltable tr:nth-child(2) td:nth-child(4)" "css_element"
    And I should see "Available" in the "Demo campaign" "table_row"
    And I should see "Archived" in the ".generaltable tr:nth-child(3) td:nth-child(5)" "css_element"
  ...
  Scenario: Report source campaign statistics
    ...
    # And I click on "First signup" "link"
    # And I click on "Most recent sign up" "link"
    ...
    # Confirmed Users
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(2)" "css_element"
    And I should see "2" in the ".generaltable tr:nth-child(4) td:nth-child(2)" "css_element"
    # Unconfirmed Users
    And I should see "0" in the ".generaltable tr:nth-child(3) td:nth-child(3)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(4) td:nth-child(3)" "css_element"
    ...
    # Total revenue Users
    And I should see "0" in the ".generaltable tr:nth-child(3) td:nth-child(5)" "css_element"
    And I should see "20" in the ".generaltable tr:nth-child(4) td:nth-child(5)" "css_element"
  ...
  Scenario: Report source campaign User statistics
    ...
    And I press "View" action in the "My report" report row
    And I close block drawer if open
    And I should see "2" in the ".generaltable tr:nth-child(1) td:nth-child(2)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(2) td:nth-child(2)" "css_element"
    And I log out
    ...
    And I press "View" action in the "My report" report row
    # Badge Award
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(3)" "css_element"
    And I should see "0" in the ".generaltable tr:nth-child(2) td:nth-child(3)" "css_element"
    ...
    And I press "View" action in the "My report" report row
    # Enrolled courses
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(4)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(2) td:nth-child(4)" "css_element"

    # Inprogress courses
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(5)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(2) td:nth-child(5)" "css_element"
    ...
    And I press "View" action in the "My report" report row
    # Course completed
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(6)" "css_element"
    And I should see "1" in the ".generaltable tr:nth-child(2) td:nth-child(6)" "css_element"

    # Activities completed
    And I should see "1" in the ".generaltable tr:nth-child(1) td:nth-child(7)" "css_element"
    And I should see "0" in the ".generaltable tr:nth-child(2) td:nth-child(7)" "css_element"
