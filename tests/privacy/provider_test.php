...
class provider_test extends provider_testcase {
    ...
    public function test_auth_magic_export_user_data() {
        ...
        $logrecord = $DB->get_record('auth_magic_loginlinks', ['userid' => $user->id]);
        ...
        $this->assertEquals(transform::datetime($logrecord->loginexpiry), reset($data->MagicLogins)['loginexpiry']);
        $this->assertEquals(transform::datetime($logrecord->invitationexpiry), reset($data->MagicLogins)['invitationexpiry']);
    }
    ...
    public function test_delete_data_for_all_users_in_context() {
        ...
        $records = $DB->get_records('auth_magic_loginlinks', []);
        // There should be two.
